...
- | **Start** | **End** | Who          | **Activity**                                                 |
  ...
  | 1:30p     | 1:45p   | Lab          | Hands-on Lab - Evaluate Predictor in console<br />[See Getting Started Tutorial, Steps 19-21](https://github.com/aws-samples/amazon-forecast-samples/blob/master/ForecastCheatSheet.md#tutorial).  <br />[Watch a demo video.](https://amazon-forecast-samples.s3-us-west-2.amazonaws.com/demo_videos/forecast_pipeline_through_console.mp4) (minutes 8:45 - 9:45) |
  | 1:45p     | 2:00p   | Lab          | Hands-on Lab - Create Forecast, Lookup in console through query, and visualize a QuickSight Dashboard)<br />[See Generating Forecasts](https://github.com/aws-samples/amazon-forecast-samples/blob/master/ForecastCheatSheet.md#forecastinference)<br />[Watch a demo video](https://amazon-forecast-samples.s3-us-west-2.amazonaws.com/demo_videos/forecast_pipeline_through_console.mp4) (minutes 9:45-end, ~4min) |
