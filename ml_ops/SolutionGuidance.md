...
|PredictorForecastDimensions |You may want to forecast at a finer grain than item.  Here, you can specify dimensions such as location, cost center or whatever your needs are.  This needs to agree with the dimensions in your RTS and TTS. | [CreateAutoPredictor](https://github.com/awsdocs/amazon-forecast-developer-guide/blob/main/doc_source/API_CreateAutoPredictor.md)
